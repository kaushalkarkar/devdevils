...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-payment-list" data-toggle="list1" href="paymentnav.php" role="tab" aria-controls="home">Payment</a> 
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Profile</a>
      <a class="list-group-item list-group-item-action" href="document.php" id="list-document-list" role="tab"  aria-controls="home">Document Upload</a>
